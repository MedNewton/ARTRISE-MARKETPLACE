...
function DisplayMemberOwnedNfts(props) {
  const { address, artistData } = props;
              ...
              <div className="row sorry">
                <div className="col-12">
                  <h2 className="tf-title-heading ct style-2 fs-30 mg-bt-10">
                    Sorry, We Couldn’t Find Any Artworks that is Owned by
                    {' '}
                    {artistData?.name}
                  </h2>
                  <h5 className="sub-title help-center mg-bt-32 ">
                    The content of this page will updated as soon as
                    {' '}
                    {artistData?.name}
                    {' '}
                    purchase one
...
DisplayMemberOwnedNfts.propTypes = {
...
DisplayMemberOwnedNfts.defaultProps = {
  address: '',
  artistData: PropTypes.shape({
    name: '',
  }),
