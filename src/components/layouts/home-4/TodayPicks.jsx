                                ...
                                <div key={index} className="fl-item col-xl-3 col-lg-4 col-md-6 col-sm-6">
                                    <div className={`sc-card-product menu_card style2 ${item.feature ? 'comingsoon' : '' } `}>
                                        ...
                                        <div className="card-media">
                                            <Link to={{pathname: "/item-details-01", search: `?title=${item.title}` }}><img src={item.img} alt="Axies" /></Link>
                                            <Link to="/login" className="wishlist-button heart"><span className="number-like">{item.wishlist}</span></Link>
                                            <div className="coming-soon">{item.feature}</div>
                                        </div>
                                        <div className="card-title">
                                            <h5 className="style2"><Link to={{pathname: "/item-details-01", search: `?title=${item.title}` }}>"{item.title}"</Link></h5>
