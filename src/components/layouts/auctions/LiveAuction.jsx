    ...
    <div className="fl-item col-xl-3 col-lg-6 col-md-6">
        <div className="sc-card-product">
            <div className="card-media">
                <Link to={{pathname: "/item-details-01", search: `?title=${props.item.title}` }}><img src={props.item.img} alt="axies" /></Link>
            ...
            <div className="card-title">
                <h5><Link to={{pathname: "/item-details-01", search: `?title=${props.item.title}` }}>{props.item.title}</Link></h5>
            ...
            <div className="meta-info">
                <div className="author">
                    ...
                    <div className="info">
                        <span>Creator</span>
                        <h6> <Link to="/Artists/Yann_Faisant">{props.item.nameAuthor}
                        </Link> </h6>
                    </div>
                </div>
                <div className="price">
