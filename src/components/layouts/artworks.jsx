                ...
                <div className="row" id='TDP'>
                    <div className="col-md-12">
                        <div className="heading-live-auctions mg-bt-21">
                            <h2 className="tf-title pad-l-7 ourArtists">
                                Artworks
                            </h2>
                    ...
                    <div className="col-md-12">
                        <div className="filtersBtn" onClick={(e) => setOpenPanel(true)}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 7H21" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path><path d="M6 12H18" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path><path d="M10 17H14" stroke="black" strokeWidth="1.5" strokeLinecap="round"></path></svg>
                        </div>
                        <SlidingPane
                    ...
                    
                    {
                                    !isLoading && listings ? (
                                        listings?.map((listing) => {
                                            if((listing.id != 0) && (listing.id != 17) && (listing.id != 21) && ((listing.id != 28)) && ((listing.id != 29)) && (listing.id >= 16))
                                            {
                                                return (
                    ...
                    {
                        visible < data.length && 
                        <div className="col-md-12 wrap-inner load-more text-center" hidden> 
