...
const HeaderStyle2 = () => {
    ...
    useEffect(() => {
        ...
        let acceuilLink = document.querySelector('#menu-primary-menu > li:nth-child(1) > a');
        let exploreLink = document.querySelector('#menu-primary-menu > li.menu-item.menu-item-has-children > a');
        let dropsLink = document.querySelector('#menu-primary-menu > li:nth-child(3) > a');
        let profileLink = document.querySelector("#menu-primary-menu > li:nth-child(4)");
    ...
    async function passwordlessLogin(snapshot){
        ...
        console.log("profile : " + pdp)
        console.log(snapshot.val().pdpLink)
        ...
        await get(ThisUserRef).then(async (snapshot) => {
            ...
            if(dt == null) {
                await set(ref(db, 'users/'+adr), {
                    ...
                    'pdpLink': "https://media.istockphoto.com/id/1332100919/vector/man-icon-black-icon-person-symbol.jpg?s=612x612&w=0&k=20&c=AVVJkvxQQCuBhawHrUhDRTCeNQ3Jgt0K1tXjJsFy1eg=",
                    'cover_link': "https://img.freepik.com/free-photo/abstract-luxury-blur-grey-color-gradient-used-as-background-studio-wall-display-your-products_1258-52609.jpg?w=2000",
                        ...
                        <div id="site-header-inner"> 
                            <div className="wrap-box flex">
                                ...
                                <div className="sc-btn-top mg-r-12" id="site-header">
                                            <Link to="/" onClick={(e)=>{e.preventDefault(); open()}} className="sc-button header-slider style style-1 wallet fl-button pri-1"><span>{address.toString().slice(0, 6)}...{address.toString().substring(address.toString().length - 3)}
                                            </span></Link>
                                        </div>
                                            ...
                                            <div className="avatar_popup mt-20" ref={avtToggle}>
                                                <div className="d-flex align-items-center mt-10">
                                                    <div className="info ml-12">
                                                        <p className="text-sm font-book text-gray-400 popup-name">{userName}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="links mt-20">
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <span className='popup-white-text popup-links'> Profile</span>
                                                    </Link>
                                                    ...
                                                    <svg width="16" height="16" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <span className='popup-white-text popup-links'> Wallet</span>
                                                    </a>
                                                    <a className="mt-10" href="" id="logout" onClick={Logout}>
                                                    <svg width="16" height="16" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <span className='popup-white-text popup-links'> Logout</span>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div id="site-header-inner"> 
                                <div className="wrap-box flex">
                                    ...
                                    <nav id="main-nav" className="main-nav" ref={menuLeft}>
                                        ...
                                        <Link to={'/wallet-connect'} id="mwc">
                                            <div className="mobileWalletConnect">
                                                <div className='btn btn-primary mobileWalletBtn'>Connect wallet</div>
                                            </div>
                                        </Link>
                                    </nav>
                                    <div className="question-form">
                                    ...
                                    <div className="flat-search-btn flex">
                                        ...
                                        <div className="sc-btn-top mg-r-12" id="site-header">
                                            <Link to="/" onClick={(e)=>{e.preventDefault(); setLoginModalOpen(true)}} className="sc-button header-slider style style-1 wallet fl-button pri-1"><span>Login
                                            </span></Link>
                                        </div>
