...
function LazyDisplay() {
  ...
  const getNFTData = useCallback(async (nftIDProp) => {
    ...
    await get(artworkRef).then(async (snapshot) => {
      ...
      setPhysicalImages(snapshot.val()?.physical_images);
                    ...
                    <Accordion key="0" title="Properties">
                      <div className="row propertiesBox">
                        {nft?.data?.attributes
                          ...
                          : (
                            <div className="col-3 attr">
                              <p className="attributeTitle">Trait</p>
                              <p className="attributeValue">Value</p>
                            </div>
                          )}
                      </div>
                    </Accordion>
                  ...
                  <div className="physicalImages">
                    ...
                    <div className="row" style={{ marginBottom: '3%' }}>
                      {nft?.data?.physical_images?.map((image, index) => (
                        ...
                        >
                          <span className="visually-hidden">Open Image Viewer</span>
                          <img
                            src={image.image_url}
                            className="physImg"
                            style={{ margin: '2px' }}
