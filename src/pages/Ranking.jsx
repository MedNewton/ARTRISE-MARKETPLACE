...
const Ranking = () => {
    const [data] = useState(
        [
            ...
            {
                img: img1,
                title: "Portret van Hortense de Beauharnais, koningin van Holland, Anne-Louis Girodet-Trioson, ca. 1805 - ca. 1809    carré",
                imgAuthor: yann,
                nameAuthor: 'Yann Faisant',
                volume: '12,4353',
                day: '+3456%',
                                            ...
                                            <div className="item flex">
                                                <div className="infor-item flex column1">
                                                    ...
                                                    <div className="content-collection pad-t-4">
                                                        <h5 className="title mb-15"><Link to={{pathname: "/item-details-01", search: `?title=${item.title}` }}>"{item.title}"</Link></h5>
                                                        <div className="author flex">
                                                            ...
                                                            <div className="content">
                                                                <p>Owned By</p>
                                                                <h6><Link to="/Artists/Yann_Faisant">{item.nameAuthor}</Link></h6>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
