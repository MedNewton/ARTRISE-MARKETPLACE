...
const MyPendingArtworks = () => {
  ...
  const [myPendingArtworks, setMyPendingArtworks] = useState([]);
  ...
  async function getMyPendingArtworks(adr) {
      ...
      <div className="tf-create-item tf-section">
        <div className="themesflat-container">
          <div className="row profilePadding ">
                      ...
                      <div className="tagLink">
                        <Dropdown>
                          ...
                          <Dropdown.Menu>
                            ...
                            >
                              <p
                                className="tagLinkDropdownItemText"
                                style={{ color: "#808080" }}
                              >
            ...
            {address ? (
              myPendingArtworks.map((artwork, id) => {
                if (artwork) {
                  return (
                    <div
                      key={id}
                    ...
                    >
                      <div className={`sc-card-product`}>
                        ...
                        <div className="card-title">
                          <h5 className="style2">{artwork.title}</h5>
                        </div>
                      </div>
                    </div>
                  );
...
export default MyPendingArtworks;
