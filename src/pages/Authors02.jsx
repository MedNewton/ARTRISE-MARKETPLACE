            ...
            <HeaderStyle2 />
            {
                ...
                <div className="themesflat-container">
                    <div className="flat-tabs tab-authors artistProfile">
                        <div className="author-profile flex" style={{background: `url(${cover})`}}>
                            <div className="feature-profile">
                                <img src={pdp} alt="" className="avatar" />
                            </div>
                            ...
                            <div className="widget-social style-3">
                                <ul>
                                    {
                                        instagram != "" ? (
                                            <li className="style-2"><Link target={"_blank"} to={"//"+instagram}><i className="fab fa-instagram"></i></Link></li>
                                        ):("")
                                    }
                                    {
                                        facebook != "" ? (
                                            <li className="mgr-none"><Link target={"_blank"} to={"//"+facebook}><i className="fab fa-facebook"></i></Link></li>
                                        ):("")
                                    }
                                    {
                                        twitter != "" ? (
                                            <li><Link target={"_blank"} to={"//"+twitter}><i className="fab fa-twitter"></i></Link></li>
                                        ):("")
                                    }
                                    {
                                        website != "" ? (
                                            <li><Link target={"_blank"} to={"//"+website}><i className="fa fa-globe"></i></Link></li>
                                        ):("")
                                    }
                                </ul>
